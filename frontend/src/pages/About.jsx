    ...
    <div className="about-page">
      ...
      <section className="page-body-section">
        <div className="content-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.8rem', marginBottom: '4rem' }}>
            <div className="glass-panel" style={{ padding: '2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1.1rem', marginBottom: '1.2rem' }}>
                ...
                <h3 style={{ fontSize: '1.3rem', color: 'var(--primary-navy)', margin: 0 }}>Indexing & Proceedings</h3>
              </div>
            ...
            <div className="glass-panel" style={{ padding: '2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1.1rem', marginBottom: '1.2rem' }}>
                <div style={{ width: '50px', height: '50px', minWidth: '50px', flexShrink: 0, borderRadius: 'var(--radius-md)', background: 'rgba(2, 132, 199, 0.12)', color: '#0284C7', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Globe2 size={26} />
                </div>
                <h3 style={{ fontSize: '1.3rem', color: 'var(--primary-navy)', margin: 0 }}>Hybrid Global Mode</h3>
              </div>
              <p style={{ fontSize: '0.92rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
            ...
            <div className="glass-panel" style={{ padding: '2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1.1rem', marginBottom: '1.2rem' }}>
                <div style={{ width: '50px', height: '50px', minWidth: '50px', flexShrink: 0, borderRadius: 'var(--radius-md)', background: 'rgba(5, 150, 105, 0.12)', color: '#059669', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Users size={26} />
                </div>
                <h3 style={{ fontSize: '1.3rem', color: 'var(--primary-navy)', margin: 0 }}>Peer Review Rigor</h3>
              </div>
              <p style={{ fontSize: '0.92rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
          ...
          <div className="glass-panel" style={{ padding: '2.5rem', background: 'var(--surface-white)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1rem' }}>
              <Building size={24} color="var(--primary-cyan)" />
